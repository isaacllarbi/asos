...
class MyAppBar extends StatefulWidget with PreferredSizeWidget {
  ...
  const MyAppBar({Key key, this.scaffoldKey, this.controller})
      : super(key: key);
  ...
  Size get preferredSize => Size(double.infinity, kToolbarHeight*1.9);
}
...
class _MyAppBarState extends State<MyAppBar>
  ...
  Widget build(BuildContext context) {
    ...
    var tabBar =
        TabBar(controller: widget.controller, tabs: [homeTab, catTab, newTab]);
